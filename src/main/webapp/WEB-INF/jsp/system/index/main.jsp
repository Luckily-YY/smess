...
<base href="<%=basePath%>">
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div style="padding-left: 70%;padding-top: 1px;">
							<div style="float: left;margin-top: 3px;"><img src="${pageContext.request.contextPath}/static/images/loadingi.gif" /> </div>
		...
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/elements.typeahead.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/elements.wysiwyg.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/elements.spinner.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/elements.treeview.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/elements.wizard.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/elements.aside.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.ajax-content.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.touch-drag.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.sidebar.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.sidebar-scroll-1.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.submenu-hover.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.widget-box.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.settings.js"></script>
		<script src="${pageContext.request.contextPath}/static/ace/js/ace/ace.settings-rtl.js"></script>
		...
		<!--引入弹窗组件2start-->
		<script type="text/javascript" src="${pageContext.request.contextPath}/plugins/attention/drag/drag.js"></script>
