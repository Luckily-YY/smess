...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/ace/js/bootbox.js"></script>
    <!-- 软键盘控件start -->
...
<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
    ...
    <div id="windows1">
        <div id="loginbox">
            ...
            <div class="controls">
                <div class="main_input_box">
                    <font color="white"><span id="nameerr">© Chen smess</span></font>
                </div>
            </div>
        </div>
    </div>
    <!-- 注册 -->
    <div id="windows2" style="display: none; margin-top: -130px;">
        <div id="loginbox">
            <form action="" method="post" name="loginForm" id="loginForm">
                <div class="control-group normal_text">
                    <h3>
            ...
            <div class="controls">
                <div class="main_input_box" style="margin-top: -10px;">
                    <font color="white"><span id="nameerr">© Chen smess</span></font>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function severCheck() {
        if (check()) {
            ...
            var code = "smesslogin1" + loginname + ",smess," + password + "smesslogin2" + ",smess," + $("#code").val();
            $.ajax({
                type: "POST",
                url: 'login_login',
...
<c:if test="${'1' == pd.msg}">
    <script type="text/javascript">
        ...
        function tsMsg() {
           ...
           /* bootbox.alert('此用户在其它终端已经早于您登录,您暂时无法登录');*/
        }
    </script>
</c:if>
<c:if test="${'2' == pd.msg}">
    <script type="text/javascript">
        ...
        function tsMsg() {
            ...
            /*bootbox.alert('您被系统管理员强制下线或您的帐号在别处登录')*/
        }
    </script>
</c:if>
