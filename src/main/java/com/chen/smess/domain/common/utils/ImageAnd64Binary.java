...
public class ImageAnd64Binary {
    public static void main(String[] args){
		...
		String imgSrcPath 	 = "d:/Smess/123.jpg";     //生成64编码的图片的路径
		String imgCreatePath = "D:\\javaTomcat\\apache-tomcat-8.0.45\\webapps/pro/ueditor2/jsp/upload1/20140318/480ace2bfc6e44608595bd4adbdeb067.jpg";     //将64编码生成图片的路径
