package com.chen.smess.app.controller.pictures;
...
public class PicturesController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("pictures/pictures_list");
	...
	public ModelAndView listfortc(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = picturesService.list(page);	//列出Pictures列表
		mv.setViewName("pictures/pictures_list_tc");
		mv.addObject("varList", varList);
		mv.addObject("pd", pd);
		mv.addObject("QX",Jurisdiction.getHC());	//按钮权限
		return mv;
	...
	public ModelAndView goAdd() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("pictures/pictures_add");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goEdit() throws Exception{
		...
		mv.setViewName("pictures/pictures_edit");
	...
	public ModelAndView goImageCrawler() throws Exception{
		ModelAndView mv = this.getModelAndView();
		mv.setViewName("pictures/imageCrawler");
		return mv;
	}
