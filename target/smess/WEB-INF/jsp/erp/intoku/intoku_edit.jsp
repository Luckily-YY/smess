					...
					<form action="intoku/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="BIANMA" id="BIANMA" value="" maxlength="32" placeholder="请输入商品编码" title="商品商品编码" style="width:99%;" /></td>
							</tr>
							<%--<tr>
							...
							<tr>
								...
								<td><input type="text" name="GOODS_NAME" id="GOODS_NAME"  maxlength="32"  title="商品名称" style="width:99%;"  /></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">数量:</td>
								<td><input onblur="jisuanz();" type="number" name="INCOUNT" id="INCOUNT" maxlength="32" title="数量" style="width:99%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">单价:</td>
								<td><input onblur="jisuanz();" type="number" name="PRICE" id="PRICE"  maxlength="32" placeholder="这里输入单价（进价）" title="单价" style="width:89%;"/>&nbsp;元</td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">总价:</td>
								<td><input type="number" name="ZPRICE" id="ZPRICE"  maxlength="32" placeholder="总价" title="总价" style="width:89%;"/>&nbsp;元</td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注:</td>
								<td>
								<textarea rows="" cols="" name="BZ" id="BZ" style="width:99%;"></textarea>
								</td>
							</tr>
							<tr>
